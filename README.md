...
**PaperGate** یک سامانه تحت وب است که برای مدیریت، دسته‌بندی و نمایش مقالات و پایان‌نامه‌های دانشگاهی طراحی شده است.
...
* **Categories:** مدیریت دسته‌بندی‌ها با پشتیبانی از زیر‌دسته‌ها.
