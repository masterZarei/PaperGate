...
namespace PaperGate.Infra.Migrations
{
    ...
    [Migration("20260815023101_Mig_GenericIdentityDbContext")]
    partial class Mig_GenericIdentityDbContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaperGate.Core.Entities.Keywords.KeywordInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PaperGate.Core.Entities.Keywords.PostKeywordInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PaperGate.Core.Entities.UsefulLinkInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PaperGate.Core.Entities.UserInfo", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PaperGate.Core.Entities.Keywords.PostKeywordInfo", b =>
                {
                    b.HasOne("PaperGate.Core.Entities.Keywords.KeywordInfo", "Keyword")
                        .WithMany()
                        .HasForeignKey("KeywordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PaperGate.Core.Entities.PostInfo", "Post")
                        .WithMany("Keywords")
